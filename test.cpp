...
void printAccountInformation(CreditAccount theAccount) {
  ...
  cout.precision(2);
  cout << "Date of opening" << setw(20) << "Open Balance " << setw(20)
       << "Interest Rate " << setw(20) << "Term of Credit " << setw(20)
       << "Balance at Mature " << endl;
  cout << theAccount.dateofOpen << setw(20) << setfill(' ')
       << theAccount.balance << setw(20) << theAccount.interestRate << setw(20)
       << theAccount.term << setw(20)
       << getCurrentBalance(theAccount, theAccount.term) << endl;
}
...
void printAccountInformation(LoanAccount theAccount) {
  ...
  cout << "Date of opening" << setw(20) << "Open Balance" << setw(20)
       << "Interest Rate" << setw(20) << "Length of loan" << setw(20)
       << "Monthly payment" << endl;
  cout << setw(20) << theAccount.dateofOpen << setw(20) << setfill(' ')
       << theAccount.balance << setw(20) << theAccount.interestRate << setw(20)
       << theAccount.term << setw(20) << getMonthlyPayment(theAccount) << endl;
}
