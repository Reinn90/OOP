...
/*
 * 7.1 How many operators the class has overloaded and what are they?
 * 2 function overloading
 * operator++
 * operator<<
 *
 * How to read a date from a file and write a date into a file?
 * 
 * using fstream - ifstream and ofstream in dateApp.cpp
 *
 *
 */
using namespace std;
